...
// Buckets Unicode's ~50 version numbers into "eras" so the color legend
// stays readable. Boundaries follow major/notable releases -- one bucket
// per major version number from 7.0 on (each is its own yearly release), a
// few grouped together for the sparser early decades.
const ERAS = [
  { key: 'e1', max: 1.1, ja: '1.x', en: 'v1.x(1991-1993)' },
  { key: 'e2', max: 2.1, ja: '2.x', en: 'v2.x(1996-1998)' },
  { key: 'e3', max: 3.2, ja: '3.x', en: 'v3.x(1999-2002)' },
  { key: 'e4', max: 4.1, ja: '4.x', en: 'v4.x(2003-2005)' },
  { key: 'e5', max: 5.2, ja: '5.x', en: 'v5.x(2006-2009)' },
  { key: 'e6', max: 6.3, ja: '6.x', en: 'v6.x(2010-2013)' },
  { key: 'e7', max: 7.0, ja: '7.0', en: 'v7.0(2014)' },
  { key: 'e8', max: 8.0, ja: '8.0', en: 'v8.0(2015)' },
  { key: 'e9', max: 9.0, ja: '9.0', en: 'v9.0(2016)' },
  { key: 'e10', max: 10.0, ja: '10.0', en: 'v10.0(2017)' },
  { key: 'e11', max: 11.0, ja: '11.0', en: 'v11.0(2018)' },
  { key: 'e12', max: 12.1, ja: '12.x', en: 'v12.x(2019)' },
  { key: 'e13', max: 13.0, ja: '13.0', en: 'v13.0(2020)' },
  { key: 'e14', max: 14.0, ja: '14.0', en: 'v14.0(2021)' },
  { key: 'e15', max: 15.1, ja: '15.x', en: 'v15.x(2022-2023)' },
  { key: 'e16', max: 16.0, ja: '16.0', en: 'v16.0(2024)' },
  { key: 'e17', max: Infinity, ja: '17.x以降', en: 'v17.x+(2025-)' },
];
